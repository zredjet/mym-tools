...
## v0.1.0-alpha.7 の主な変更

- LinkとMemoを独立モジュールへ分離し、Memoの一覧・詳細・作成・編集をページ化
- 既存の単独Memoを起動時バックアップ後に自動移行し、旧exportのimport互換を維持
- LinkとMemoの100件を超える一覧表示・並び替えに対応
- モジュールショートカットをPrompt / Link / Memo / Color / Hash / Paletteへ固定
